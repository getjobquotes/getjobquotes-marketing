...
export default function AppFooter() {
  return (
    <footer className="border-t border-[rgb(var(--border))] px-4 sm:px-6 py-10 mt-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-8">
          ...
          <div>
            ...
            <div className="space-y-1.5">
              {[
                ...
                <Link key={href} href={href} className="block text-xs text-[rgb(var(--text-faint))] hover:text-[rgb(var(--text-muted))] transition">{label}</Link>
              ))}
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="space-y-1.5">
              ...
              <a href="mailto:hello@getjobquotes.uk" className="block text-xs text-[rgb(var(--text-faint))] hover:text-[rgb(var(--text-muted))] transition">
                hello@getjobquotes.uk
              </a>
            </div>
          </div>
        </div>
        <div className="border-t border-[rgb(var(--border))] pt-5 flex flex-col sm:flex-row items-center justify-between gap-2">
