#!/bin/bash
# Add real Terms & Privacy pages
# cd ~/projects/getjobquotes-marketing && bash fix-legal-pages.sh
...
git add .
git commit -m "legal: full UK GDPR privacy policy and terms & conditions with real content (data tables, third-party processors, ICO contact, cookie breakdown, user rights)"
git push origin main

echo ""
echo "✅ Done — both pages live:"
echo "   https://getjobquotes.uk/terms"
echo "   https://getjobquotes.uk/privacy"
