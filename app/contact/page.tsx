...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-[rgb(var(--bg))] text-[rgb(var(--text))]">
      <nav className="sticky top-0 z-50 border-b border-[rgb(var(--border))] bg-black/95 backdrop-blur-sm px-5">
        <div className="max-w-4xl mx-auto h-14 flex items-center justify-between">
          ...
          <Link href="/auth?mode=signup"
            className="px-4 py-2 text-sm font-semibold bg-green-600 hover:bg-green-500 text-[rgb(var(--text))] rounded-lg transition">
            Try Free
          </Link>
        </div>
      </nav>
      ...
      <div className="max-w-2xl mx-auto px-5 py-14">
        <h1 className="text-3xl font-bold mb-3 text-[rgb(var(--text))]">Contact Us</h1>
        <p className="text-[rgb(var(--text-muted))] mb-10">Got a question or need help? We would love to hear from you.</p>

        <div className="grid sm:grid-cols-2 gap-4 mb-10">
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--surface)/0.5)] p-6">
            <div className="text-2xl mb-3">📧</div>
            <h2 className="text-sm font-bold mb-1 text-[rgb(var(--text))]">General Enquiries</h2>
          ...
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--surface)/0.5)] p-6">
            ...
            <h2 className="text-sm font-bold mb-1 text-[rgb(var(--text))]">Technical Support</h2>
        ...
        <div className="rounded-2xl bg-[rgb(var(--surface)/0.5)] border border-[rgb(var(--border))] p-6 mb-8">
          <h2 className="text-base font-bold mb-3 text-[rgb(var(--text))]">Frequently Asked Questions</h2>
          <div className="space-y-4 text-sm">
            {[
              ...
              <div key={q}>
                <p className="font-semibold text-[rgb(var(--text))]">{q}</p>
                <p className="text-[rgb(var(--text-muted))] mt-0.5">{a}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center">
          <Link href="/auth?mode=signup"
            className="inline-block px-6 py-3 bg-green-600 hover:bg-green-500 text-[rgb(var(--text))] font-bold rounded-xl text-sm transition">
