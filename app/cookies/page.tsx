  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--bg))] text-[rgb(var(--text))]">
      ...
      <div className="max-w-2xl mx-auto px-5 py-16">
        ...
        <p className="text-[rgb(var(--text-faint))] text-xs mb-10">Last updated: March 2026</p>
        <div className="guide-content space-y-6">
          <p className="text-[rgb(var(--text-muted))]">This Cookie Policy explains how GetJobQuotes (&quot;we&quot;, &quot;us&quot;) uses cookies and similar technologies when you visit getjobquotes.uk.</p>
