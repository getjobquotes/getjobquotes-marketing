...
export const metadata: Metadata = {
  ...
  description: "How to use Invoices in GetJobQuotes. Step-by-step guide for UK tradespeople.",
};
...
export default function HelpInvoicesPage() {
  return (
    <HelpLayout
      title="Invoices"
      description="Everything you need to know about Invoices in GetJobQuotes."
      breadcrumb="Invoices"
      related={[
